    ...
    public void processRequest() throws Exception {
        ...
        if (StringUtil.isBlank(action)) {
            ...
            if ("sas".equalsIgnoreCase(action)) {
                ...
                HashMap answerMap = generateFileService.createODMFile(odmVersion, sysTimeBegin, generalFileDir, db, this.currentStudy, "", eb, currentStudy.getId(), currentStudy.getParentStudyId(), "99", true, true);
