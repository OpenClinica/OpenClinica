...
public class VariableSubstitutionHelper {
    ...
    private static Map<String, String> buildTokensMap(DisplaySectionBean section, StudySubjectBean studySubject,
        ...
        tokensMap.put("studySubject", studySubject.getName());
        tokensMap.put("studyName", study.getName());
        tokensMap.put("eventName", event.getName());
        tokensMap.put("eventOrdinal", Integer.toString(event.getOrdinal()));
        tokensMap.put("crfName", section.getCrf().getName());
        tokensMap.put("crfVersion", section.getCrfVersion().getName());
