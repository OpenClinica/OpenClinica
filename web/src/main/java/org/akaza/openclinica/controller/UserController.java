...
public class UserController {
    ...
    public ResponseEntity<Object> extractPartcipantsInfo(HttpServletRequest request, @PathVariable( "studyOID" ) String studyOid, @PathVariable( "siteOID" ) String siteOid,
    		@RequestParam( value = "includeRelatedInfo", defaultValue = "n", required = false ) String includeRelatedInfo) throws InterruptedException {
        utilService.setSchemaFromStudyOid(studyOid);
        ...
        if(includeRelatedInfo!=null && includeRelatedInfo.trim().toUpperCase().equals("Y")) {
        	incRelatedInfo = true;
        }
