...
public class OdmController {
     ...
     * Right now security disabled on this ...
     * You can call this with http://localhost:8080/OpenClinica-web-MAINLINE-SNAPSHOT/pages/odmk/studies/S_DEFAULTS1/events
     *
     * @param studyOid
     * @return
     * @throws Exception
    ...
    public
    @ResponseBody
    ODM createBoom(@PathVariable("studyOid") String studyOid,
                   @PathVariable("studySubjectOid") String studySubjectOid) throws Exception {
    ...
    private ODMcomplexTypeDefinitionFormData getFormDataPerCrf(CRFVersionBean crfVersion,
                                                               StudyEventBean nextEvent,
    ...
    private ODMcomplexTypeDefinitionStudyEventData generateStudyEventData(StudyEventBean studyEvent){
        ...
        studyEventData.setEventName(studyEvent.getName());
        return studyEventData;
    }

    private ODMcomplexTypeDefinitionFormData generateFormData(CRFVersionBean crfVersionBean,
                                                              StudyEventBean nextEvent,
        ...
        if (eventCRFBean == null){
            ...
            if (eventCRFBean.getStatus().equals(Status.UNAVAILABLE)){
