...
public class ErrorConstants {
    ...
    public static final String ERR_REPEAT_KEY_TOO_LARGE = "errorCode.eventNotScheduled.repeatKeyTooLarge";
    public static final String ERR_INVALID_REPEAT_KEY = "errorCode.eventNotScheduled.invalidRepeatKey";
