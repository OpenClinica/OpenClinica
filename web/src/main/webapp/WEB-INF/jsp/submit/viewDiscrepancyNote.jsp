                            ...
                            <tr class="aka_stripes">
                                <td class="aka_header_border" colspan="4">
                                    ...
                                    <div style="float: right; padding-left: 30px;">
                                    	<fmt:message key="Last_updated" bundle="${resword}"/>: <b><fmt:formatDate value="${note.value.lastDateUpdated}" pattern="${dteFormat}"/> by <c:out value="${note.value.lastUpdator}"/></b><br>
