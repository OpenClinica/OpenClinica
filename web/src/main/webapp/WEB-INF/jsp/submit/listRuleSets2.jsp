...
<c:choose>
<c:when test="${userBean.sysAdmin && module=='admin'}">
 <h1 style="margin:0em"><span class="title_manage"><fmt:message key="rule_manage_rule_assignment" bundle="${resworkflow}"/> <c:out value="${study.name}" /> <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/rules')"><span class=""></span></a>
</c:when>
<c:otherwise>
 <h1 style="margin:0em"><span class="title_manage"><fmt:message key="rule_manage_rule_assignment" bundle="${resworkflow}"/> <c:out value="${study.name}" /> <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/rules')"><span class=""></span></a>
</c:otherwise>
