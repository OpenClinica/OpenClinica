	  	...
	  	<td valign="top">
			...
			<tr>
				...
				<td>
				    ...
				    <span name="flag_schLocation" class="icon icon-flag blue" border="0" alt="<fmt:message key="discrepancy_note" bundle="${resword}"/>" title="<fmt:message key="discrepancy_note" bundle="${resword}"/>"></a></c:if>
                </td>
			</tr>
			<tr>
