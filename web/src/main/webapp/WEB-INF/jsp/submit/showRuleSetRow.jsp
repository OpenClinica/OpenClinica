    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td><a href="ViewRuleSetAudit?ruleSetId=<c:out value="${currRow.bean.id}"/>"
                     ...
                     onMouseUp="javascript:setImage('bt_Audit1','images/icon_NotStarted.gif');"><span
                name="bt_Remove1" class="icon icon-doc" border="0" alt="<fmt:message key="audit_logs" bundle="${resword}"/>" title="<fmt:message key="audit_logs" bundle="${resword}"/>" align="left" hspace="6"></a>
              </td>
      </tr>
    </table>
  </td>
