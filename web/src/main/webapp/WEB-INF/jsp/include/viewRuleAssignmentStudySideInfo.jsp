...
<c:choose>
    ...
    <b><fmt:message key="study_xml" bundle="${resword}"/>:</b>&nbsp; 
        <b><a href="DownloadStudyMetadata?studyId=<c:out value="${study.id}"/>"></b><fmt:message key="download" bundle="${resword}"/></a>
    <br><br>    


    <b><fmt:message key="unique_crfs" bundle="${resword}"/>:</b>&nbsp; <c:out value="${crfCount}"/>

    <br><br>
    <b><fmt:message key="unique_items" bundle="${resword}"/>:</b>&nbsp; <c:out value="${itemCount}"/>

    <br><br>
    <b><fmt:message key="unique_rule_assignments" bundle="${resword}"/>:</b>&nbsp; <c:out value="${ruleSetCount}"/>
