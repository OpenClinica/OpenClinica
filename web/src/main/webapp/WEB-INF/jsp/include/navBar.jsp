                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td align="right" style="font-weight: normal;">
                                        ...
                                        <form METHOD="GET" action="${urlPrefix}ListStudySubjects" onSubmit=" if (<c:out value="document.forms[0]['findSubjects_f_studySubject.label'].value"/> == '<fmt:message key="study_subject_ID" bundle="${resword}"/>') { document.forms[0]['findSubjects_f_studySubject.label'].value=''}">
                                            ...
                                            <input type="text" name="findSubjects_f_studySubject.label" onblur="if (<c:out value="this.value"/> == '') this.value = '<fmt:message key="study_subject_ID" bundle="${resword}"/>'" onfocus="if (<c:out value="this.value"/> == '<fmt:message key="study_subject_ID" bundle="${resword}"/>') this.value = ''" value="<fmt:message key="study_subject_ID" bundle="${resword}"/>" class="navSearch"/>
