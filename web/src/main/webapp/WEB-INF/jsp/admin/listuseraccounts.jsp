...
<h1><span class="title_manage"><fmt:message key="administer_users" bundle="${resword}"/> <a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/openclinica-user-guide/overview-user-types-and-roles')"><span class=""></span></a></span></h1><br/>
