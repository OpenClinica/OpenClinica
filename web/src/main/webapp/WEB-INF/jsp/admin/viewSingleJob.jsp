...
<h1><span class="title_manage"><fmt:message key="view_job" bundle="${resword}"/>: <c:out value="${triggerBean.fullName}" /><a href="javascript:openDocWindow('https://docs.openclinica.com/3.1/brief-overview/jobs')">&nbsp; <img src="images/bt_Help_Manage.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></span></h1>
