...
<h1><span class="title_manage"><fmt:message key="edit_dataset" bundle="${resword}"/> - <fmt:message key="specify_dataset_properties" bundle="${resword}"/> </span></h1>
</c:otherwise>
</c:choose>
...
<table>
	...
	<tr>
		<td></td>
		<td><c:if test="${newDataset.id>0}"><fmt:message key="change_dataset_name_create_copy" bundle="${restext}"/></c:if>
			<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="dsName"/></jsp:include>
		</td>
	</tr>
	...
	<tr>
		<td></td>
		<td><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="dsDesc"/></jsp:include></td>
	</tr>
...
<table>
 ...
 <fmt:message key="long_note6" bundle="${restext}"/>
	...
	<tr>
		...
		<td width="30%"><fmt:message key="metadataversion_ODM_ID" bundle="${resword}"/>         </td>
