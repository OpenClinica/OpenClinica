...
<h1 style="margin:0em"><span class="title_manage"><fmt:message key="create_dataset" bundle="${resword}"/>: <fmt:message key="select_event_attributes" bundle="${resword}"/></span></h1>
