...
* Conditions : None
*
* Author/Dt  : Shriram Mani   04/10/2008
*
* Comments   :
*
--------------------------------------------------------------------------*/
...
create sequence audit_event_val_audit_id_seq start with 1;
create sequence audit_log_event_audit_id_seq start with 10;
create sequence audit_log_event_type_id_seq start with 28;
create sequence completion_status_id_seq start with 1;
...
create sequence study_id_seq start with 2;
...
create sequence rule_id_seq start with 1;
create sequence rule_set_id_seq start with 1;
create sequence rule_set_audit_id_seq start with 1;
create sequence rule_set_rule_id_seq start with 1;
create sequence rule_set_rule_audit_id_seq start with 1;
create sequence rule_action_id_seq start with 1;
create sequence rule_expression_id_seq start with 1;
