...
<h1>
  <span class="title_manage">
    <fmt:message key="enter_or_validate_data" bundle="${resword}"/>
                          ...
                          <td valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td class="table_cell">
                                  <c:out value="${studyEvent.subjectEventStatus.name}"/>
                                </td>
                              </tr>
                              <tr>
                                <td class="table_header_column">
                                    ...
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:if test="${studySubject.status.name != 'removed'&& studySubject.status.name != 'auto-removed' && !userRole.monitor}">
                                          ...
                                          <c:if test="${dec.startDoubleDataEntryPermitted}">
                                            <td>
                                              <a href="#" onMouseDown="javascript:setImage('bt_EnterData1','images/bt_EnterData_d.gif');"
                                              onMouseUp="javascript:setImage('bt_EnterData1','icon icon-pencil-squared');"
                                              onclick="return checkCRFLocked'<c:out value="${dec.eventCRF.id}"/>', '<c:out value="${actionQuery}"/>');">
                                        ...
                                        <c:if test="${(userRole.director || userRole.coordinator) && (subjectStudy.status.available) && (versionCount>1 || differentFormVersionAvailable) && !(studyEvent.subjectEventStatus.locked || studyEvent.subjectEventStatus.skipped)}">
                                          <td>
