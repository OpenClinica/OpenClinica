        ...
        <tr>
            ...
            <td valign="bottom" id="Tab2'">
                <div id="Tab2NotSelected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="<fmt:message key="view_by_event_CRF" bundle="${resword}"/>" href='viewAllSubjectSDVtmp?studyId=${studyId}&sdv_f_sdvStatus=Ready+to+Verify+%26+Changed+since+verified' onclick="javascript:HighlightTab(2);"><fmt:message key="view_by_event_CRF" bundle="${resword}"/></a></div></div></div></div>
...
<div id="subjectSDV">
    <form name='sdvForm' action="${pageContext.request.contextPath}/pages/viewAllSubjectSDVform">
       ...
       <%--This value will be set by an onclick handler associated with an SDV button --%>
        ...
        <input type="hidden" name="redirection" value="viewAllSubjectSDVform?sdv_restore=true&studyId=${param.studyId}">
