        ...
        <tr>
            <td valign="bottom" id="Tab1'">
              <div id="Tab1Selected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
					<a class="tabtext" title="<fmt:message key="view_by_event_CRF" bundle="${resword}"/>" href='viewAllSubjectSDVtmp?sdv_restore=true&studyId=${studyId}&sdv_f_sdvStatus=Ready+to+Verify+%2B+Changed+since+verified' onclick="javascript:HighlightTab(1);"><fmt:message key="view_by_event_CRF" bundle="${resword}"/></a></div></div></div></div>
