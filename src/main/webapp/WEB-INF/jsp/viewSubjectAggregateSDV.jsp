<<<<<<< HEAD:src/main/webapp/WEB-INF/jsp/viewSubjectAggregateSDV.jsp
...
<div id="searchFilterSDV">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td valign="bottom" id="Tab2'">
                <div id="Tab2NotSelected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
					<a class="tabtext" title="View By Participant ID" href='viewSubjectSDV?studyId=${studyId}&studySubjectId=${studySubjectId}&decorator=mydecorator' onclick="javascript:HighlightTab(2);">View By Participant ID</a></div></div></div></div>
                <div id="Tab2Selected" style="display:none"><div class="tab_BG_h"><div class="tab_L_h"><div class="tab_R_h"><span class="tabtext">View By Participant ID</span></div></div></div></div></td>
...
<jsp:include page="include/footer.jsp"/>
>>>>>>> OC-11521: Merged core to web working:ws/src/main/webapp/WEB-INF/jsp/viewSubjectAggregateSDV.jsp
