...
<jsp:useBean scope='request' id='definition' class='core.org.akaza.openclinica.bean.managestudy.StudyEventDefinitionBean'/>
...
<p><fmt:message key="click_the_up_down_arrow_icons" bundle="${restext}"/></p>
    <div style="float:right;padding-right:6px;width:8%">
       <a href="javascript:processPrintCRFRequest('rest/metadata/html/print/<c:out value="${study.oc_oid}"/>/<c:out value="${definition.oid}"/>/*')"
