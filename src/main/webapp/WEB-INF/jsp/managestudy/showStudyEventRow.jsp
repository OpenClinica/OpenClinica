...
<tr>
    ...
    <td class="table_cell">
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <td>
                <c:if test="${ !userRole.monitor && study.status.available && studySub.status.name != 'removed' && studySub.status.name != 'auto-removed' && currRow.bean.studyEvent.removed != true  && currRow.bean.studyEvent.archived != true }">
                        ...
                        <tr>
                            ...
                            <td class="table_cell" width="140">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                             <c:if test="${ !userRole.monitor && study.status.available && studySub.status.name != 'removed' && studySub.status.name != 'auto-removed' && currRow.bean.studyEvent.removed !=true && currRow.bean.studyEvent.archived !=true && dec.eventCRF.removed != true && dec.eventCRF.archived != true  && dec.eventCRF.formLayout.status.name != 'Removed' }">
