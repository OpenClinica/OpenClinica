                                                                                ...
                                                                                <ul>
                                                                                    ...
                                                                                    <c:if test="${userRole.monitor}">
                                                                                        ...
                                                                                        <li><a href="${urlPrefix}ListStudySubjects"><fmt:message
                                                                                                key="nav_subject_matrix" bundle="${resword}"/></a></li>
                                                                                        <li>
                                                                                            <a href="${urlPrefix}pages/viewAllSubjectSDVtmp?sdv_restore=${restore}&studyId=${study.studyId}&sdv_f_sdvStatus=Ready+to+Verify+%2B+Changed+since+verified"><fmt:message
