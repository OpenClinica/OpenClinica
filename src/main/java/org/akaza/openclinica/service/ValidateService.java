...
public interface ValidateService {
    ...
    boolean isUserHas_CRC_INV_DM_DEP_DS_SM_RoleInSite(List<StudyUserRoleBean> userRoles, String siteOid);

    boolean isUserHas_DM_DEP_DS_RoleInStudy(List<StudyUserRoleBean> userRoles, String studyOid);

    boolean isUserHas_DM_DEP_DS_SM_RoleInStudy(List<StudyUserRoleBean> userRoles, String studyOid);
