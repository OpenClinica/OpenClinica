...
public class EditFormController {
    ...
    //        return new ResponseEntity<String>(editURL.getFormUrl(), org.springframework.http.HttpStatus.NOT_ACCEPTABLE);
        ...
        editURL = urlService.getActionUrl(formContext, subjectContext, studyOID, formLayout, PARTICIPATE_FLAVOR, null, role, mode, null, false, EnketoAPI.INTERFACE_QUERIES, formContainsContactData, binds, ub);
