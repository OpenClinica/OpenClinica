package core.org.akaza.openclinica.dao.hibernate.multitenant;
...
import static core.org.akaza.openclinica.dao.hibernate.multitenant.CurrentTenantIdentifierResolverImpl.DEFAULT_TENANT_ID;
...
@Component public class MultiTenantFilter implements Filter {
    ...
    @Override public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        request.setAttribute("enableEmbeddedReports", CoreResources.getField("insight.enableEmbeddedReports"));
