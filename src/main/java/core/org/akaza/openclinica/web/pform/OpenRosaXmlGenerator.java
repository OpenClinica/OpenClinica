...
import core.org.akaza.openclinica.dao.hibernate.RuleActionPropertyDao;
...
import core.org.akaza.openclinica.web.pform.dto.Body;
import core.org.akaza.openclinica.web.pform.dto.Group;
import core.org.akaza.openclinica.web.pform.dto.Html;
import core.org.akaza.openclinica.web.pform.dto.Label;
import core.org.akaza.openclinica.web.pform.dto.Model;
import core.org.akaza.openclinica.web.pform.dto.Repeat;
import core.org.akaza.openclinica.web.pform.dto.UserControl;
import core.org.akaza.openclinica.web.pform.widget.Widget;
import core.org.akaza.openclinica.web.pform.widget.WidgetFactory;
...
public class OpenRosaXmlGenerator {
    ...
    public String buildForm(String formId) throws Exception {
        try {
            ...
            IOUtils.copy(getClass().getResourceAsStream("/core/properties/xform_template.xml"), writer, "UTF-8");
