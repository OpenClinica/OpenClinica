...
public interface StudySubjectService {
    ...
    void updateStudySubject(StudySubject studySubject, int userBeanId, Boolean unsignIfSigned);

    void updateStudySubject(StudySubjectBean studySubject, UserAccountBean userBean, Boolean unsignIfSigned);
