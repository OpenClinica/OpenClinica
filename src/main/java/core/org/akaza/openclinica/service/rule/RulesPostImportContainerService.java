...
import core.org.akaza.openclinica.domain.rule.expression.*;
import core.org.akaza.openclinica.service.rule.expression.ExpressionService;
import core.org.akaza.openclinica.validator.rule.action.EventActionValidator;
import core.org.akaza.openclinica.validator.rule.action.InsertActionValidator;
...
public class RulesPostImportContainerService {
    ...
    private void isRuleActionValid(RuleActionBean ruleActionBean, AuditableBeanWrapper<RuleSetBean> ruleSetBeanWrapper,
        ...
        RuleActionRunBean ruleActionRun= ruleActionBean.getRuleActionRun();
           ...
           String message ="";
         String emailSubject="";
		if (ruleActionBean instanceof core.org.akaza.openclinica.domain.rule.action.NotificationActionBean){
		...
		if (ruleActionBean instanceof core.org.akaza.openclinica.domain.rule.action.EmailActionBean)
