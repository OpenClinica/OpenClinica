...
public interface ParticipantService {
	 ...
	 abstract String createParticipant(SubjectTransferBean subjectTransfer, Study currentStudy, String accessToken, String customerUuid, UserAccountBean userAccountBean, Locale locale) throws Exception;
