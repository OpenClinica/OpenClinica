...
import core.org.akaza.openclinica.core.OCCommonTablesSpringLiquibase;
import core.org.akaza.openclinica.core.OCMultiTenantSpringLiquibase;
import core.org.akaza.openclinica.core.OCSpringLiquibase;
...
public class LiquibaseOnDemandServiceImpl implements LiquibaseOnDemandService {
    ...
    public Study process(StudyInfoObject studyInfoObject, UserAccountBean ub) throws Exception {
        ...
        try {
            ...
            schemaStudy.setBoardUrl(studyInfoObject.getStudy().getBoardUrl());
