...
public class StudyGroupClassListBean {
    ...
    private List<core.org.akaza.openclinica.bean.odmbeans.StudyGroupItemBean> studyGroupItems;

    public StudyGroupClassListBean() {
        studyGroupItems = new ArrayList<core.org.akaza.openclinica.bean.odmbeans.StudyGroupItemBean>();
    }
    ...
    public void setStudyGroupItems(List<core.org.akaza.openclinica.bean.odmbeans.StudyGroupItemBean> studyGroupItems) {
        this.studyGroupItems = studyGroupItems;
    }

    public List<core.org.akaza.openclinica.bean.odmbeans.StudyGroupItemBean> getStudyGroupItems() {
