...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:exsl="http://exslt.org/common"
                extension-element-prefixes="exsl" xmlns:OpenClinica="http://www.openclinica.org/ns/odm_ext_v130/v3.1"
    ...
    <xsl:variable name="eventColHeaders">
        <xsl:apply-templates select="/odm:ODM/odm:Study[1]/odm:MetaDataVersion/odm:StudyEventDef"
...
<xsl:param name="subjectItems" />
                ...
                <xsl:variable name="numericStart">
                    <xsl:choose>
                        ...
                        <xsl:when test="ends-with($nextToken,'CRF Version ID')">
                            <xsl:value-of select="substring-before($nextToken,'CRF Version ID')"/>
                        </xsl:when>
                                        ...
                                        <xsl:if test="$colType = 'CRF Version ID'">
                                            <xsl:choose>
                                                <xsl:when test="$formData/@OpenClinica:FormLayoutOID">
                                                    <td class="table_cell">
                                                        <xsl:value-of select="$formData/@OpenClinica:FormLayoutOID"/>
                                                    </td>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <td class="table_cell">
    ...
    <xsl:template match="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData"
    ...
    <xsl:template match="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData[@StudyEventOID]"
                  mode="studyEventHeader">
        <xsl:variable name="eventOID" select="@StudyEventOID"/>
        <xsl:variable name="eventPosition">
            <xsl:for-each
    ...
    <xsl:template match="/odm:ODM/odm:Study/odm:MetaDataVersion/odm:StudyEventDef[@OID]"
                  mode="studyFormAndDataItemsHeaders">
