...
**Abstract:**  
This documents contains the definitions for tests that concern the management of rules. Rules are used for validation, showing or hiding items, sending mails and scheduling events.  
