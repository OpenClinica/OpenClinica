...
## T006-7: change the properties of a CRF assigned to an event on study level
...
## T006-8: change the properties of a CRF assigned to an event on site level
**description:**  
...
## T006-9: remove an assigned CRF from an event
**description:**  
...
**prerequisite:**  
You must be logged in to a study for which you have the data-manager-role and you must have successfully completed step **T006-9: remove an assigned CRF from an event**. 
