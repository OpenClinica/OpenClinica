        ...
        <tr>
            ...
            <td valign="bottom" id="Tab2'">
                <div id="Tab2Selected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Participant ID" href='pages/viewSubjectAggregate?studyId=${studyId}' onclick="javascript:HighlightTab(2);">View By Participant ID</a></div></div></div></div>
