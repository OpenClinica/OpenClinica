...
<jsp:useBean scope="request" id="father" class="core.org.akaza.openclinica.bean.submit.SubjectBean"/>
<jsp:useBean scope="request" id="mother" class="core.org.akaza.openclinica.bean.submit.SubjectBean"/>
