/*--------------------------------------------------------------------------
*
* File       : oracle_create_tablespace.sql
*
* Subject    : Creates tablespaces based on database size (user param)
*
* Parameters : 1. Tablespace Name
*              2. Tablespace Size
*              3. Datafile Name
*
* Conditions : This step is not necessary if the tablespace is not created
*
* Author/Dt  : Shriram Mani 12/12/2007
*
* Comments   : If you don't pass any parameter, then the tablespace is
*               not created.
*
--------------------------------------------------------------------------*/
set echo off
