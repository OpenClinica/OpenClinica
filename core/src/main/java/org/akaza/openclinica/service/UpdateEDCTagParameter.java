...
public class UpdateEDCTagParameter {
    ...
    public UpdateEDCTagParameter(EventDefinitionCrf eventDefinitionCrf, UserAccount userAccount, OCodmComplexTypeDefinitionConfigurationParameters conf,
