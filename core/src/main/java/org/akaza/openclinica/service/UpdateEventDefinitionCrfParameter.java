...
public class UpdateEventDefinitionCrfParameter {
    ...
    public UpdateEventDefinitionCrfParameter(EventDefinitionCrf eventDefinitionCrf, UserAccount userAccount, CrfBean crf, CrfVersion crfVersion,
